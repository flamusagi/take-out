...
public class ReportServiceImpl implements ReportService {
    ...
    public TurnoverReportVO getTurnoverStatistics(LocalDate begin, LocalDate end) {
        ...
        //存放每天的营业额
        /**
         * beginTime 2024-04-28T00:00
         * date=2024-04-28;
         * LocalTime.MIN=00:00
         * endTime 2024-04-28T23:59:59.999999999同理
         */
        ...
        for (LocalDate date : dateList) {
            ...
            Double turnover =getTurnOver(beginTime,endTime,Orders.COMPLETED);
    ...
    private Double getTurnOver(LocalDateTime begin, LocalDateTime end, Integer status){
        Map map = new HashMap();
        map.put("begin",begin);
        map.put("end",end);
        map.put("status",status);

        return orderMapper.sumTurnOverByMap(map);
    }
